...
class Graph:
    ...
    def draw_convergence_rate(convergence_data, algorithm_name="EA"):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join(utils.images_dir, f'convergence_rate_{algorithm_name}.png'))
        plt.close()
    ...
    def draw_solution_quality(final_fitness_values, algorithm_name="EA"):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(utils.images_dir, f'solution_quality_{algorithm_name}.png'))
        plt.close()
    ...
    def draw_diversity_of_solutions(diversity_data, algorithm_name="EA"):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join(utils.images_dir, f'diversity_of_solutions_{algorithm_name}.png'))
        plt.close()
    ...
    def draw_computational_efficiency(problem_sizes, runtimes, algorithm_name="EA"):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join(utils.images_dir, f'computational_efficiency_{algorithm_name}.png'))
        plt.close()
    ...
    def draw_robustness_and_stability(stability_data, algorithm_name="EA"):
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(utils.images_dir, f'robustness_and_stability_{algorithm_name}.png'))
        plt.close()
